# Response values here must be unicode strings, but you should use this in all
...
class ExampleHealthcheckAction(HealthcheckAction):
    ...
    The base class handles the main logic for you - you just need to supply one
    or more check_ methods. It will find anything beginning check_ and call it,
    expecting you to return either:
    ...
    code and description are pairs of "error code" strings with human-readable strings,
