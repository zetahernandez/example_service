...
class SquareAction(Action):
    ...
    request_schema = fields.Dictionary({
        # Requests are always dictionaries. Here we say we want a dict with exactly
    ...
    def run(self, request):
        ...
        """
        # Request is a dictionary, so it's easy to pull out fields.
        square = request['number'] ** 2
        # Return the result
